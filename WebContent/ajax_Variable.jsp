...
<body>
	<table class="table table-hover table-condensed">
		...
		<%
			...
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getInt("tyrelife")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getInt("reusedtyrelife")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getInt("tyrecost")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getInt("reusedtyrecost")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getInt("tyres")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("dieselcost")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("dieselmileage")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("diesealmileagewithload")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("toll")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("routeexpenses")%>'></td>
			<td><input type="text" readonly="readonly"
				value='<%=rs1.getFloat("maintenancecostperkm")%>'></td>
			</tr>
		</tbody>
