...
<body>
	...
	<% 
		...
		<tr>
							...
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("r.driver/cleaner salary")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("r.driver/cleaner bhatta")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("r.maintenancepermonth")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("roadtaxyear")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("roadpermityear")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getFloat("insuranceaspercentageofvechiclecost")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("admin costs")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("tarpaulin")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("profitmargin")%>'
							></td>
							<td><input type="text" readonly="readonly"
								value='<%=rs1.getInt("loadingcharges")%>'
							></td>
						</tr></tbody>
